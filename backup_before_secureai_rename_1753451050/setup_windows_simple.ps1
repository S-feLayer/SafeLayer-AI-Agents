# Simple Windows Setup Script for secureai MCP
Write-Host "🚀 secureai Windows Setup" -ForegroundColor Green
Write-Host "================================"
...
# Install secureai
Write-Host "📦 Installing secureai..." -ForegroundColor Yellow
python -m pip install --upgrade pip
python -m pip install git+https://github.com/postralai/secureai@main
Write-Host "✅ secureai installed" -ForegroundColor Green

# Create .env file
Write-Host "🔧 Creating .env file..." -ForegroundColor Yellow
$envContent = "# secureai Environment Variables`n# Add your Tinfoil API key here`nTINFOIL_API_KEY=your_api_key_here`n`n# Optional: Set custom paths`n# SecureAI_CACHE_DIR=./cache`n# SecureAI_LOG_LEVEL=INFO"
